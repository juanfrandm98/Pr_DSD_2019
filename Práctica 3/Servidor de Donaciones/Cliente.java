...
public class Cliente {
	...
	public static void main( String args[] ) {
		...
		try {
			...
			Registry mireg = LocateRegistry.getRegistry( "127.0.0.1", 1100 );

			Servidor_I miservidor = (Servidor_I)mireg.lookup( "mmiservidor" );
			...
			do {
				...
				switch( opcion1 ){
					case "1":
						...
						numReplica = miservidor.login( usuario, contrasenia );
							...
							do {
								...
								switch( opcion2 ){
									case "1":
										...
										miservidor.donar( cantidad, usuario, numReplica );
									...
									case "2":
										...
										double donado = miservidor.getDonado( usuario, numReplica );
